...
export class OverallQuesTickReportComponent implements OnInit {
	...
	switchToSep_Nov() {
		this.switchToSeptNov = this.switchToSeptNov == "0" ? "1" : "0";
		this.switchToSeptNovText =
			this.switchToSeptNov == "0"
				? "Show September to 3rd November"
				: "Showing September to 3rd November";
		this.endDate = this.model1.end
			? moment(this.model1.end._d).format("YYYY-MM-DD")
			: moment(new Date()).format("YYYY-MM-DD");
		this.startDate = this.model1.start

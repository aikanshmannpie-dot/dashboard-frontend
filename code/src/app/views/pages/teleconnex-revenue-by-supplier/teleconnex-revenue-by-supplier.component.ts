...
@Component({
	...
	templateUrl: "./teleconnex-revenue-by-supplier.component.html",
	styleUrls: ["./teleconnex-revenue-by-supplier.component.scss"],
	animations: [
...
export class TeleconnexRevenueBySupplierComponent implements OnInit {
			...
			.subscribe(
				(data) => {
					if (data) {
						...
						this.supplierData = data.supplierData;
						console.log("data.supplierData==", data);
					} else {
					}
				},
				(error) => {

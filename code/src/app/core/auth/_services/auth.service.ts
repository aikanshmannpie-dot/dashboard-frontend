...
export class AuthService {
  ...
  login(email: string, password: string): Observable<any> {
    ...
    return this.http.post<User>(`${API_USERS_URL}/login`, data, {
      headers: httpHeaders,
    });
  }
  ...
  getAffilate(startDate, endDate): Observable<any> {
    ...
    return this.http
      .get<User>(
        `${API_USERS_URL}/affiliate-by-report/${startDate}/${endDate}`,
        { headers: httpHeaders }
      )
      .pipe(
        map((res: User) => {
  ...
  getOverAllReport(startDate, endDate): Observable<any> {
    ...
    return this.http
      .get<User>(`${API_USERS_URL}/over-all-report/${startDate}/${endDate}`, {
        headers: httpHeaders,
      })
      .pipe(
        map((res: User) => {

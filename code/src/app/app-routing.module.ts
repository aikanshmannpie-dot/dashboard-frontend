...

	{
		...
		children: [
			...
			},
			{
				...
				loadChildren: () =>
					import(
						"./views/pages/overall-report/overall-report.module"
					).then((m) => m.OverallReportModule),
			},
			{
				path: "affilate/:type",
				loadChildren: () =>
					import(
						"./views/pages/affilate-report/affilate-report.module"
					).then((m) => m.AffilateReportModule),
			},
			{
				path: "clickout-report/:type",
				loadChildren: () =>
					import(
						"./views/pages/clickout-report/clickout-report.module"
					).then((m) => m.ClickoutReportModule),
			},
			{
			...
			},
			{
				...
				loadChildren: () =>
					import(
						"./views/pages/microsite-leads/microsite-leads.module"
					).then((m) => m.MicrositeLeadsModule),
			},
			{
				path: "microsite-report/:type",
				loadChildren: () =>
					import(
			...
			},
			{
				...
				loadChildren: () =>
					import(
						"./views/pages/source-report/source-report.module"
					).then((m) => m.SourceReportModule),
			},
...

			{
				...
				loadChildren: () =>
					import(
						"./views/pages/vicidial-leads/vicidial-leads.module"
					).then((m) => m.VicidialLeadsModule),
			},
			{
			...
			},
			{
				...
				loadChildren: () =>
					import(
						"./views/pages/agent-report/agent-report.module"
					).then((m) => m.AgentReportModule),
			},
			{

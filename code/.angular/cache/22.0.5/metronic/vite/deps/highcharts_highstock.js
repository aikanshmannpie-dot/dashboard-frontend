 ...
 - ${i4}: ${e4}`, l2 && (h2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        return o.jQuery && (o.jQuery.fn.highcharts = function() {
          ...
          return t3.forEach((t4) => {
            if (t4.length > 1) for (r2 = s2 = t4.length - 1; r2 > 0; r2--) (o2 = t4[r2] - t4[r2 - 1]) < 0 && !a2 ? (e3?.(), e3 = void 0) : o2 && (void 0 === i3 || o2 < i3) && (i3 = o2);
          }), i3;
        ...
        class g extends i2 {
          ...
          updateTransform() {
            ...
            if (a(t3, { marginLeft: `${d2}px`, marginTop: `${c2}px` }), "SPAN" === t3.tagName) {
              let r3 = [i3, n2, t3.innerHTML, h2, this.textAlign].join(","), d3 = -(this.parentGroup?.padding * 1) || 0, c3, m = false;
        ...
        class G {
          ...
          setTickPositions() {
            ...
            if (this.tickmarkOffset = this.categories && "between" === t3.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0, this.single = this.min === this.max && y(this.min) && !this.tickAmount && (this.min % 1 == 0 || false !== t3.allowDecimals), e3) n2 = e3.slice();
              ...
              if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) n2 = [this.min, this.max], S(19, false, this.chart);
              else if (this.dateTime) n2 = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, t3.units), this.min, this.max, t3.startOfWeek, this.ordinal?.positions, this.closestPointRange, true);
        ...
        class p {
          ...
          render() {
            ...
            if (!t3.chart.styledMode && (C ? (w.stroke = o2 || "#999999", w["stroke-width"] = c(e3.width, 1), e3.dashStyle && (w.dashstyle = e3.dashStyle)) : M && (w.fill = o2 || "#e6e9ff", x && (w.stroke = e3.borderColor, w["stroke-width"] = x))), p2.zIndex = n2, T += "-" + n2, (k = t3.plotLinesAndBandsGroups[T]) || (t3.plotLinesAndBandsGroups[T] = k = u.g("plot-" + T).attr(p2).add()), v || (this.svgElem = v = u.path().attr(w).add(k)), r(m)) S = t3.getPlotLinePath({ value: s2?.log2lin(m) ?? m, lineWidth: v.strokeWidth(), acrossPanes: e3.acrossPanes });
            else {
              if (!(r(f) && r(g))) return;
          ...
          renderLabel(t3, e3, i3, a2) {
            ...
            c2.align(t3, false, { x: g, y: f, width: m, height: s(u) - f }), (!c2.alignValue || "left" === c2.alignValue || r(d2)) && c2.css({ width: (t3.style?.width || (i3 && d2 ? m : 90 === c2.rotation ? n2.height - (c2.alignAttr.y - n2.top) : (t3.clip ? n2.width : n2.chart.chartWidth) - (c2.alignAttr.x - n2.left))) + "px" }), c2.show(true);
          }
          getLabelText(t3) {
        ...
        class M {
          ...
          manageEvent(t3) {
            ...
            f(i3) && (!this.hcEvents?.[t3] || this.hcEvents?.[t3]?.map((t4) => t4.fn).indexOf(i3) === -1) ? (this.importedUserEvent?.(), this.importedUserEvent = l(this, t3, i3)) : this.importedUserEvent && !i3 && this.hcEvents?.[t3] && (S(this, t3), delete this.hcEvents[t3], Object.keys(this.hcEvents) || delete this.importedUserEvent);
          }
          setState(e3, i3) {
        ...
        return (function(t3) {
          function e3(t4, e4, r) {
            let a = this.legendItem = this.legendItem || {}, { chart: n, options: l } = this, { baseline: h = 0, symbolWidth: d, symbolHeight: c } = t4, p = this.symbol || "circle", u = c / 2, g = n.renderer, f = a.group, m = h - Math.round((t4.fontMetrics?.b || c) * (r ? 0.4 : 0.3)), x = {}, y, b = l.marker, v = 0;
        ...
        class X {
          ...
          setOptions(t3) {
            ...
            this.tooltipOptions = I(p.tooltip, p.plotOptions.series?.tooltip, c2?.tooltip, i3.userOptions.tooltip, h2.series?.tooltip, u2.tooltip, r2.tooltip), this.stickyTracking = G(r2.stickyTracking, u2.stickyTracking, d2.stickyTracking, !!this.tooltipOptions.shared && !this.noSharedTooltip || g2.stickyTracking), null === l2.marker && delete g2.marker, this.zoneAxis = g2.zoneAxis || "y";
          ...
          setData(t3, e3 = true, i3, s2) {
            ...
            if (h2 && h2.enabled && (t3 = this.sortData(t3)), l2.options.chart.allowMutatingData && false !== s2 && M2 && a2 && !o2.cropped && !o2.hasGroupedData && o2.visible && !o2.boosted && (b2 = this.updateData(t3, i3)), !b2) {
              ...
              for (u2 && R(u2[0]) && w(14, true, l2), o2.data = [], o2.options.data = o2.userOptions.data = t3, x2 = a2; x2--; ) r2[x2]?.destroy();
          ...
          setState(t3, e3) {
            ...
            if (t3 = t3 || "", i3.state !== t3 && ([i3.group, i3.markerGroup, i3.dataLabelsGroup].forEach(function(e4) {
              ...
              if (t3 && (l2 = a2[t3].lineWidth || l2 + (a2[t3].lineWidthPlus || 0), h2 = G(a2[t3].opacity, h2)), o2 && !o2.dashstyle && j(l2)) for (let t4 of [o2, ...this.zones.map((t5) => t5.graph)]) t4?.animate({ "stroke-width": l2 }, n2);
        ...
        class L {
          ...
          colorizeItem(t3, e3) {
            ...
            if (s2?.[e3 ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
              ...
              o2?.css(C(e3 ? this.itemStyle : s3)), r2?.attr(p2({ stroke: d2 || t3.color })), a2 && a2.attr(p2(c2 && a2.isMarker ? t3.pointAttribs() : { fill: t3.color })), i3?.attr(p2({ fill: l2 || t3.color, "fill-opacity": l2 ? 1 : h2 ?? 0.75 }));
            }
        ...
        class Q {
          ...
          setZoomOptions() {
            ...
            this.zooming = __spreadProps(__spreadValues({}, e3), { type: V(t3.zoomType, e3.type), key: V(t3.zoomKey, e3.key), pinchType: V(t3.pinchType, e3.pinchType), singleTouch: V(t3.zoomBySingleTouch, e3.singleTouch, false), resetButton: U(e3.resetButton, t3.resetZoomButton) });
          }
          init(t3, e3) {
          ...
          getChartSize() {
            let t3 = this.options.chart, e3 = t3.width, i3 = t3.height, s2 = this.getContainerBox(), o2 = s2.height > 1 && !(!this.renderTo.parentElement?.style.height && "100%" === this.renderTo.style.height);
        ...
        function S() {
          ...
          n2 && [s2, "-" + s2].forEach((i4) => {
            ...
            for (; s3--; ) a3 = r2[s3], t3 = e3.getStackIndicator(t3, a3, e3.index, i4), l2 = o2[i4]?.[a3], (h2 = l2?.points[t3.key || ""]) && n2.call(e3, h2, l2, s3);
          });
        }
        function k(t3, e3, i3) {
            ...
            t3.visible && t3.hasDataLabels?.() && (e4.forEach((t4) => {
              ...
              h2 && (t3.sortByAngle(e5, a3 - 0.5), k > 0 && (f2 = Math.max(0, g2 - c2 - k), m3 = Math.min(g2 + c2 + k, i4.plotHeight), e5.forEach((t4) => {
                ...
                (i5.dataLabels || []).forEach((l2) => {
                  let h3 = l2.options || {}, g3 = i5.distributeBox, f3 = l2.dataLabelPosition, m4 = f3?.natural.y || 0, b3 = h3.connectorPadding || 0, k2 = l2.lineHeight || 21, M2 = (k2 - l2.getBBox().height) / 2, C = 0, A = m4, w = "inherit";
                  if (f3) {
          ...
          for (let i3 of t3.series || []) if (i3.visible && i3.hasDataLabels?.()) {
            let s2 = (i4) => {
              for (let s3 of i4) s3.visible && (s3.dataLabels || []).forEach((i5) => {
                let o2 = i5.options || {};
                i5.labelrank = a(o2.labelrank, s3.labelrank, s3.shapeArgs?.height), o2.allowOverlap ?? Number(o2.distance) > 0 ? (i5.oldOpacity = i5.opacity, i5.newOpacity = 1, l(i5, t3)) : e3.push(i5);
              });
            };
        ...
        class P {
          ...
          renderElements() {
            ...
            if ([!i3, i3, !i3].forEach((i4, o3) => {
            ...
            }), t3.outline || (t3.outline = r2.path().addClass("highcharts-navigator-outline").add(n2)), s2.styledMode || t3.outline.attr({ "stroke-width": e3.outlineWidth, stroke: e3.outlineColor }), e3.handles?.enabled) {
              ...
              [0, 1].forEach((e4) => {
                ...
                } else t3.handles[e4]?.destroy(), t3.handles[e4] = r2.symbol(h2, -l2 / 2 - 1, 0, l2, o3, i4), t3.handles[e4].attr({ zIndex: 7 - e4 }).addClass("highcharts-navigator-handle highcharts-navigator-handle-" + ["left", "right"][e4]).add(n2), t3.addMouseEvents();
          ...
          update(t3, e3 = false) {
            ...
            if (this.navigatorEnabled && (this.isDirty = true, false === t3.adaptToUpdatedData && this.baseSeries.forEach((t4) => {
              ...
              this.xAxis.update(__spreadProps(__spreadValues({}, t3.xAxis), { offsets: e4, [i3.inverted ? "width" : "height"]: this.height, [i3.inverted ? "height" : "width"]: void 0 }), false), this.yAxis.update(__spreadProps(__spreadValues({}, t3.yAxis), { [i3.inverted ? "width" : "height"]: this.height }), false);
            }
            e3 && i3.redraw();
          }
          render(t3, e3, i3, s2) {
          ...
          onMouseMove(t3) {
            ...
            (!t3.touches || 0 !== t3.touches[0].pageX) && (l2 = (t3 = i3.pointer?.normalize(t3) || t3).chartX, a2 && (n2 = e3.top, l2 = t3.chartY), e3.grabbedLeft ? (e3.hasDragged = true, e3.render(0, 0, l2 - n2, e3.otherHandlePos)) : e3.grabbedRight ? (e3.hasDragged = true, e3.render(0, 0, e3.otherHandlePos, l2 - n2)) : e3.grabbedCenter && (e3.hasDragged = true, l2 < r2 ? l2 = r2 : l2 > s2 + r2 - o2 && (l2 = s2 + r2 - o2), e3.render(0, 0, l2 - r2, l2 - r2 + o2)), e3.hasDragged && e3.scrollbar && C(e3.scrollbar.options.liveRedraw, !d && !this.chart.boosted) && (t3.DOMType = t3.type, setTimeout(function() {
              e3.onMouseUp(t3);
            }, 0)));
          }
          onMouseUp(t3) {
          ...
          modifyBaseAxisExtremes() {
            let t3, e3;
            let i3 = this.chart.navigator, s2 = this.getExtremes(), o2 = s2.min, r2 = s2.max, a2 = s2.dataMin, n2 = s2.dataMax, l2 = r2 - o2, h2 = i3.stickToMin, d2 = i3.stickToMax, c2 = C(this.ordinal?.convertOverscroll(this.options.overscroll), 0), p2 = i3.series && i3.series[0], u2 = !!this.setExtremes;
